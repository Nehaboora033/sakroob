    ...
    <div className='max-w-[1396px] px-3 mx-auto'>
      ...
      <div className='grid grid-cols-1 gap-6'>
        <div className='grid grid-cols-2 gap-6   h-[335px]'>
          <div className='blue-bg pl-[62px] flex items-center overflow-hidden '>
          ...
          <div className='grid grid-cols-2 gap-6'>
            <div className='cable-bg pt-8 text-center flex items-center flex-col justify-between '>
              <SubHeading className='text-[32px]! max-w-[213px]  mx-auto'>
                Custom PC Parts
              </SubHeading>
              <Image src={customParts} alt='custom parts' className='' />
            </div>
            <div className='grey-bg pt-[46px] flex flex-col justify-between p-3 items-center'>
              <SubHeading className='text-[32px]! text-center'>
                DIY Tools
              </SubHeading>
              <Image src={tools} alt='tools' className='' />
            </div>
          </div>
        </div>
        <div className='grid grid-cols-2 gap-6 '>
          <div className='grid grid-cols-2 gap-6 h-[335px]'>
            <div className='cable-bg pt-[26px] flex  pr-4 overflow-hidden flex-col relative '>
                <SubHeading className='text-[32px]!  mx-auto'>
                  Cables & Connectors
                </SubHeading>
              <Image src={cables} alt='cables' className='absolute bottom-0'  />
            </div>
            <div className='grey-bg pt-[22px] flex flex-col items-center p-5 justify-between'>
              <SubHeading className='text-[32px]! max-w-[241px] mx-auto text-center'>
                Gaming Peripherals
              </SubHeading>
              <Image src={gaming} alt='gaming ' className='' />
            </div>
          </div>
          <div className='blue-bg pt-[59px] overflow-hidden h-[335px] '>
            <SubHeading className='text-[32px]!  text-center'>
              Raspberry Pi Kits
            </SubHeading>
